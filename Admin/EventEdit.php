...
<body>
    ...
    <div class="container">
        ...
        if (isset($_POST["btnSave"])) {
            ...
            if ($isValid) {
                // Get NGO ID
                $queryNGO = "SELECT NGOId FROM ngo WHERE Name = '$ngo'";
        ...
        <form method="post" action="" enctype="multipart/form-data">
            ...
            Event NGO <select name="ngo">
                ...
                while ($row = mysqli_fetch_array($result)) {
                    ...
                    $ngoName = $row["Name"];
                    if ($ngo == $id)
                        echo "<option value='$ngoName' selected>$ngoName </option>";
                    else
                        echo "<option value='$ngoName'>$ngoName </option>";
                }
                ?>
            </select>
            <br />
