...
<body>
    <form method="post" action="LoginAction.php">
        ...
        // Only display error message if it exists
        ...
        <div class="form-structor">
            <div class="signup">
                <h2 class="form-title" id="signup"><span>or</span>Sign-In</h2>
                ...
                <button value="Login" class="submit-btn">Sign-In</button>
            </div>
            <div class="login slide-up">
                <div class="center" style="text-align: center;">
                    <a href="Register.php" class="form-title" id="signup"><span>or</span>Sign Up</a>
                </div>
            </div>
        </div>
    </form>
