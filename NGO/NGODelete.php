...
try {
    ...
    if (!$result || !$result2) {
        echo "Unable to delete NGO! <br/><a href='index.php'>Back to your NGO Account</a>";
    } else {
        header("Location: ../UserProfile.php");
    }
} catch (Exception $e) {
    echo "<h2 style='color:red'>Unable to delete NGO Since it have Volunteers! </h2><a href='NGO.php'>Back to your NGO Account</a>";
}
