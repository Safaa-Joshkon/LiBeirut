...
<body>
    <form class="h-100" method="post" action="RegisterAction.php">
        ...
        <div class="form-structor">
            <div class="signup slide-up" style="text-align: center;">
                <a href="Login.php" class="form-title" id="signup"><span>or</span>Sign-In</a>
            </div>
            <div class="login">
                <div class="center">
                    <h2 class="form-title" id="login">Sign Up</h2>
                    <div class="form-holder">
                        <input type="radio" name="role" value="NGO"> NGO
                        <input type="radio" name="role" value="volunteer" id="volunteer"> Volunteer
