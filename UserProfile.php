    ...
    <div class="container mt-5" style="text-align: center;">
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
            <div class="col">
                <div class="card h-100">
                    <div class="d-flex justify-content-center align-items-center" style="height: 100px;">
                        <img src="./images/historyB.png" class="card-img-top" alt="..." style="width:100px; height:100px;">
                    </div>
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="d-flex justify-content-center align-items-center" style="height: 100px;">
                        <img src="./images/sites.png" class="card-img-top" alt="..." style="width:100px; height:100px;">
                    </div>
                    <div class="card-body">
            ...
            <div class="col">
                <div class="card h-100">
                    <div class="d-flex justify-content-center align-items-center" style="height: 100px;">
                        <img src="./images/peaceB.png" class="card-img-top" alt="..." style="width:100px; height:100px;">
                    </div>
                    <div class="card-body">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <p>Please sign in to view more details.</p>
