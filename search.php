    ...
    <div class="container">
        <div class="row row-cols-1 row-cols-md-3 g-4">
            ...
            while ($row = mysqli_fetch_array($result)) {
                ...
                echo '<div class="card h-100" style="margin: 10px; border: 1px solid #ddd;">';
                echo '<img src="images\\' . $row["Poster"] . '" class="card-img-top" alt="Event Poster" style="height: 400px; width: 350px; border-radius: 15px; display: inline-block; margin: 0 auto; margin-top: 20px;">';
                ...
                // echo '<p class="card-text"><i class="fa fa-calendar" aria-hidden="true"></i> Date: ' . $row["Date"] . '</p>';
                // $time = date("h:i a", strtotime($row["Time"]));
                // echo '<p class="card-text"><i class="fa fa-clock-o" aria-hidden="true"></i> Time: ' . $time . '</p>';
